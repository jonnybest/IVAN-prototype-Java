...
/**
 * This class establishes all the necessary SSH connections and port mappings
 * for IVAN
 * 
 * @author Jonny
 * 
...
public class SshConnector {
	 ...
	 */
	private static Session mapPortToRecaaWithSsh(int remote)
			throws JSchException {
	 ...
	 * @throws JSchException
	 */
	public static void initializeRecaaConnections() throws JSchException {

		mapPortToRecaaWithSsh(4711); // wordnet

		mapPortToRecaaWithSsh(3600); // cyc
		mapPortToRecaaWithSsh(3601); // cyc
		mapPortToRecaaWithSsh(3602); // cyc
		mapPortToRecaaWithSsh(3614); // cyc
		mapPortToRecaaWithSsh(3615); // cyc
	}
}
